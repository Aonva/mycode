...
def get_ip_data():
    ...
    input_gate = input("What gate way is associaded with this device? ")
    input_location = input("What location is associaded with this device? ")
    d = {"IP": input_ip, "driver": input_driver, "gate": input_gate, "location": input_location }
    return d
